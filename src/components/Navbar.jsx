  ...
  return (
    <div className="lg:px-30 flex items-center justify-between px-6 py-4 shadow-md bg-white">
      ...
      <ul className="hidden lg:flex space-x-6">
        ...
        <Link
          className="uppercase font-semibold hover:text-blue-600"
          to="/gallery"
        >
          gallery
        </Link>
      ...
      {isOpen && (
        <div className="absolute top-16 left-0 w-full bg-white shadow-lg flex flex-col items-start space-y-4 px-8 py-4 p-4 lg:hidden">
          ...
          <Link
            className="border-2 rounded-2xl p-1 bg-sky-600 text-white uppercase font-semibold hover:bg-sky-700"
            to="/contact"
            onClick={() => setOpen(false)}
          >
            Contact
